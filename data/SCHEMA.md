...
个人/小团队用 AI 搭建的可重复运行的赚钱系统。核心判据：AI 是核心执行者、系统可重复运行、越跑越好的复利效应、直接接触真实世界的付费方。

```json
{
  "type": "agent",
  "id": "英文 slug",
  "name": "标题（≤40字，含收入金额吸引点击）",
  "industry": "14 大类同 model",
  "region": "同 model",
  "scale": "个人|小企",
  "channel": "线上",
  "y2026_hot": "为何 2026 值得关注（1-2 行）",
  "workflow": "工作流一句话描述：每天怎么跑、输入什么输出什么（2-3行）",
  "setup": "搭建这个系统需要什么：技术能力/工具/时间（2-3行）",
  "tools": ["必需工具1", "工具2"],
  "revenue": "收入情况：多少/月，什么阶段（含具体数字）",
  "cost": "成本：工具订阅/API费用/其他（1-2行）",
  "time": "每天/每周投入时间",
  "entry": "新手怎么入行（2-3行）",
  "keys": ["成功关键1", "关键2"],
  "risks": ["风险1", "风险2"],
  "example": ["真实案例1（带名称和数字）"],
  "sources": ["URL1", "URL2"]
}
```
**灵魂**：系统可复利 + 人类做裁判 + AI 接触真实世界。`workflow` / `setup` / `revenue` / `tools` / `entry` 必填。`sources` ≥2。
